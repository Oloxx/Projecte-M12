...
Route::middleware('auth')->group(function () {
    ...
    Route::match(['get', 'post'],'/collaboracio/index', [CollaboracioController::class, 'index'])->name('collaboracio.index');
    ...
    // CONTACTE CONTROLLER
    Route::match(['get', 'post'],'/contacte/index', [ContacteController::class, 'index'])->name('contacte.index');
