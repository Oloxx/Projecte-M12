...
<template>
    <section class="mb-5">
        <header>
            ...
            <p class="mt-1">
                Un cop suprimit el teu compte, tots els teus recursos i dades s'esborraran permanentment.
            </p>
        </header>
        ...
        <Modal class="modal-lg">
            ...
            <template #body>
                <p>
                    Un cop eliminat el vostre compte, tots els seus recursos i dades s'esborraran permanentment.<br>
                    Introduïu la vostra contrasenya per confirmar que voleu eliminar el vostre compte permanentment.
                </p>
                <div class="mt-4">
